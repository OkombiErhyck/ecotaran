...
export default function PlacesPage() {
 ...
 <div className="filter-item">
          ...
          <div className="marcas-buttons">
            <button
              onClick={() => setSelectedMarca('Personal Ro')}
              className={`marca-button ${selectedMarca === 'Personal Ro' ? 'active' : ''}`}
            >
              Personal Ro
            </button>
            <button
              onClick={() => setSelectedMarca('Personal Non UE')}
              className={`marca-button ${selectedMarca === 'Personal Non UE' ? 'active' : ''}`}
            >
              Personal Non UE
            </button>
          </div>
